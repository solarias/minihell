...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    _gsScope._gsDefine.plugin({
        ...
        API: 2,
        version: "1.0.0",
        overwriteProps: ["alpha", "rotation", "x", "y", "scale", "scaleX", "scaleY", "pivot", "pivotX", "pivotY", "anchor", "anchorX", "anchorY", "texture"],
            ...
            Object.keys(values).forEach(function (property) {
                ...
                switch (property) {
                    ...
                    case 'anchorY':
                        ...
                        break;
                    case 'texture':
                        self._addTween(target.texture, "texture", target.texture, value, property);
                        break;
